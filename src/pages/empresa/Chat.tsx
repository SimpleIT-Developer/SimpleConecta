...
import { MessageCircle, Send, User, Video, Phone, Calendar } from 'lucide-react';
  ...
  const conversas = [
    {
      ...
      last_message: 'Sim, estou disponível para entrevista esta semana.',
    ...
    },
    {
      ...
      last_message_time: '2024-01-14T16:30:00Z',
      unread_count: 0,
      status: 'active'
    }
  ];
  ...
  const mensagens: ChatMessage[] = [
    {
      ...
      sender_id: '1',
      sender_type: 'empresa',
      message: 'Olá João! Ficamos interessados no seu perfil para nossa vaga.',
      message_type: 'text',
    ...
    },
    {
      ...
      sender_id: '1',
      sender_type: 'empresa',
      message: 'Gostaríamos de agendar uma entrevista. Você está disponível esta semana?',
    ...
    },
    {
      ...
      sender_id: '2',
      sender_type: 'cidadao',
      message: 'Sim, estou disponível para entrevista esta semana.',
      message_type: 'text',
    ...
    <MainLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">Converse com os candidatos às suas vagas</p>
        </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-start space-x-3 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-medium text-sm truncate">{conversa.candidato_nome}</p>
                ...
                <CardHeader className="border-b">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <CardDescription>Candidato - Desenvolvedor Frontend React</CardDescription>
                    </div>
                  ...
                  <div className="flex-1 overflow-y-auto space-y-4 p-4">
                    {mensagens.map((mensagem) => (
                      <div
                        key={mensagem.id}
                        className={`flex ${
                          mensagem.sender_type === 'empresa' ? 'justify-end' : 'justify-start'
                        }`}
                      >
                        <div
                          className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${
                            mensagem.sender_type === 'empresa'
                        ...
                        >
                          ...
                          <p className={`text-xs mt-1 ${
                            mensagem.sender_type === 'empresa' ? 'text-blue-100' : 'text-gray-500'
                          }`}>
